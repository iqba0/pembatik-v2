...
toggleSearchFormButton &&
  ...
  // Event listener untuk mengklik gambar GIF
  document.getElementById("gif-image").addEventListener("click", function() {
    openFullscreen(this); // Masuk ke mode fullscreen ketika gambar diklik
  });