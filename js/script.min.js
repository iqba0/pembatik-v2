...
window.onload = function () {
  localStorage.getItem("popupDisplayed") ||
...
function closeSearchForm() {
  searchForm.classList.contains("active") &&
    ...
    setTimeout(() => {
      (searchForm.style.visibility = "hidden"), removeHighlights();
    }, 300));
}
function performSearch() {
  ...
  document.querySelectorAll(".menu-card").forEach((r) => {
    ...
    o && o.textContent.toLowerCase().includes(e)
      ? (o.classList.add("highlight"),
        t || o.scrollIntoView({ behavior: "smooth", block: "center" }),
        (t = !0))
...
toggleSearchFormButton &&
  searchForm &&
  toggleSearchFormButton.addEventListener("click", (e) => {
    e.stopPropagation(),
      searchForm.classList.toggle("active"),
      (searchForm.style.visibility = searchForm.classList.contains("active")
        ? "visible"
        : "hidden"),
      (searchForm.style.opacity = searchForm.classList.contains("active")
        ? "1"
        : "0"),
      (searchForm.style.pointerEvents = searchForm.classList.contains("active")
        ? "auto"
        : "none"),
      searchForm.classList.contains("active") && searchBox.focus(),
      e.preventDefault();
  }),
  searchIcon.addEventListener("click", function (e) {
    e.stopPropagation(), performSearch();
  }),
  searchBox.addEventListener("keydown", function (e) {
    "Enter" === e.key && (e.preventDefault(), performSearch());
  }),
  searchBox.addEventListener("input", function (e) {
    "" === searchBox.value.trim() && removeHighlights();
  }),
  document.addEventListener("click", function (e) {
    ...
    t || r || o || closeSearchForm();
  }),
  hamburgerMenu.addEventListener("click", function () {
    navbarNav.classList.toggle("active");
  }),
  document
// Mengelola thumbnail video untuk YouTube
var videoThumbnail = document.getElementById("video-thumbnail");
var videoWrapper = document.getElementById("video-wrapper");

// Menggabungkan 'click' dan 'touchstart' dalam satu fungsi
function handleVideoClick() {
  videoThumbnail.style.display = "none";
  videoWrapper.style.display = "block";
}

// Event listener untuk click dan touchstart (agar berfungsi di mobile dan desktop)
videoThumbnail.addEventListener("click", handleVideoClick);
videoThumbnail.addEventListener("touchstart", handleVideoClick);

// Mengelola GIF untuk fullscreen
var gifImage = document.getElementById("gif-image");

// Menggabungkan fungsi fullscreen dalam satu listener
...
thumbnail.addEventListener("click", function() {
  ...
  wrapper.style.display = "block";  // Tampilkan video dengan rasio 16:9
});